...
public class AdminLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_login:
                if(UserTypeSelection_Activity.isNetworkAvailable(AdminLoginActivity.this)) {
                logintoUser();
                }else {
                    UserTypeSelection_Activity.openWifISettings(AdminLoginActivity.this);
                }
    ...
    private void logintoUser() {
        ...
        if (email.isEmpty() || !UserTypeSelection_Activity.isValidEmail(email)) {
            etemail.setError("enter valid email");
            etemail.requestFocus();
        }
        else if (password.isEmpty() || password.length() < 6) {
            etpassword.setError("enter at least 6 digit/characters new password");
