...
public class Orders_list_activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    FirebaseAuth mAuth;
    FirebaseUser currentUser;
    Context context;
    AdapterOrder sales_adapter;
    ListView lvlistview;
    String TAG = "TAG";
    TextView tvNodata;
    TextView newUser;
    ...
    FirebaseRecyclerOptions<ModelOrder> options;
    RecyclerView recyclerView;
    DatabaseReference ref;
    FirebaseDatabase database;
    ArrayList<ModelOrder> listData;
    public static AdapterOrder adapter;
...
//        mProg.setCancelable(false);
        ...
        recyclerView = findViewById(R.id.rv_Orderslist);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        options = new FirebaseRecyclerOptions.Builder<ModelOrder>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("Salesman_Placed_Orders"), ModelOrder.class)
                .build();
        ...
        ref = database.getReference("Salesman_Placed_Orders");
...
//         Check if user is signed in (non-null) and update UI accordingly.
        if (mAuth.getCurrentUser() == null) {
            finish();
            Intent salesman = new Intent(Orders_list_activity.this, AdminLoginActivity.class);
            startActivity(salesman);
        }

        listData=new ArrayList<>();

        final DatabaseReference nm= FirebaseDatabase.getInstance().getReference("Salesman_Placed_Orders");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    for (DataSnapshot npsnapshot : dataSnapshot.getChildren()){
                        ModelOrder dataItem = npsnapshot.getValue(ModelOrder.class);
...
//                Toast.makeText(context, "Salesman Registered Successfully", Toast.LENGTH_SHORT).show();
            ...
            public void onChildRemoved(@NonNull DataSnapshot snapshot) {
                ModelOrder removedBook = snapshot.getValue(ModelOrder.class);

                for (int i = 0; i < listData.size(); i++) {
                    if (listData.get(i).getOrderId().equals(removedBook.getOrderId())) {
                        listData.remove(i);
                        adapter.notifyItemRemoved(i);
                        Toast.makeText(Orders_list_activity.this, "Order Deleted successfully", Toast.LENGTH_LONG).show();
...
//            Toast.makeText(Products_List.this, "press Back again to exit ", Toast.LENGTH_SHORT).show();
            ...
            finish();
            Intent salesman = new Intent(Orders_list_activity.this, Salesman.class);
            startActivity(salesman);
...
//                        break;
                    case R.id.bar_add_sale:
                        finish();
                        Intent i = new Intent(Orders_list_activity.this, SalesmanRegistrationActivity.class);
                        startActivity(i);
                        break;
                    case R.id.bar_add_prod:
                        finish();
                        Intent i2 = new Intent(Orders_list_activity.this, AddProductActivity.class);
                        startActivity(i2);
                        break;
...
//                        startActivity(i3);break;
                    case R.id.bar_order:
                        finish();
                        Intent i4 = new Intent(Orders_list_activity.this, Orders_list_activity.class);
                        startActivity(i4);
//                        Toast.makeText(Orders_list_activity.this, "Bar Shopping Click", Toast.LENGTH_LONG).show();
                        break;
                    case R.id.bar_more:
                        Toast.makeText(Orders_list_activity.this, "Bar More Click", Toast.LENGTH_LONG).show();
                        break;
                }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_salesman:
                finish();
                Intent i2 = new Intent(Orders_list_activity.this, Salesman.class);
                startActivity(i2);
                break;
...
//                startActivity(i4);
            ...
            case R.id.nav_product:
                finish();
                Intent i5 = new Intent(Orders_list_activity.this, Products_List_Activity.class);
                startActivity(i5);
                break;
            case R.id.nav_logOut:
                mAuth.signOut();
                finish();
                Intent i6 = new Intent(Orders_list_activity.this, UserTypeSelection_Activity.class);
                startActivity(i6);
                break;
        }
